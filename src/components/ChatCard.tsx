...
const ChatCard = () => {
  ...
  return (
    <Card className="max-w-xl w-full h-[200vh] min-h-[800px] max-h-[800px] glassmorphic-card pt-10 pb-4 px-4 flex flex-col items-center gap-4 shadow-2xl border-0 font-telegraph bg-white/70 backdrop-blur-xl" role="region" aria-label="Trip Planning Interface">
      <CardContent className="w-full h-full flex flex-col items-center gap-4 p-0">
        <header className="w-full flex flex-col items-center mb-2 gap-2">
          ...
          {/* Always reserve space for Status button to prevent layout shifts */}
